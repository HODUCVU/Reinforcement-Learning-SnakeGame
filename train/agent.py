...
from train_snake import Direction, Point, SnakeGameAI
from models.Linear_QNet import Linear_QNet
from models.QTrainer import QTrainer
from display.helperv2 import plot
...
class Agent:
	...
	def get_state(self, game):
		...
		""" [danger straight, danger right, danger left, danger down,
